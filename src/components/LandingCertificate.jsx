                ...
                <div className="main-content">
                    ...
                    <div className="card">
                        ...
                        <div className="product-detail">
                            <p>
                                Dear Customer,<br/>
                                Congratulations on your recent purchase of {certData.name} from BDS Machines, Germany.<br/><hr className='halfLineBreak'/>
                                Should you have any questions or need assistance, please feel free to reach out to us at. Our team is here to ensure you have the best possible experience with your new {certData.name}.<br/><hr className='halfLineBreak'/>
                          ...
                          <p>
                            ...
                            Herzlichen Glückwunsch zu Ihrem kürzlichen Kauf einer {certData.name} von BDS Maschinen GmbH.<br/><hr className='halfLineBreak'/>
                            Sollten Sie Fragen haben oder Hilfe benötigen, können Sie sich jederzeit an uns wenden. Unser Team ist hier, um sicherzustellen, dass Sie mit Ihrer neuen {certData.name} die bestmögliche Erfahrung machen.<br/><hr className='halfLineBreak'/>
